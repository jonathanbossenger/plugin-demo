# Copilot Instructions for [Your Plugin Name]

## Repository Overview

This is a WordPress plugin that [describe your plugin's purpose and functionality here].

**Repository Type:** WordPress Plugin  
**Primary Language:** [e.g., JavaScript (React/JSX), PHP]  
**Frameworks:** [e.g., WordPress Block Editor (Gutenberg), @wordpress/scripts]  
**Target Runtime:** [e.g., WordPress 6.8+, PHP 8.1+, Node.js 20+]  
**Repository Size:** [e.g., Small (~25 files, excluding dependencies)]

## Critical Build Instructions

### Environment Requirements

- **Node.js:** [e.g., v20.19.5 (tested and confirmed working)]
- **npm:** [e.g., v10.8.2 (tested and confirmed working)]
- **PHP:** [e.g., 8.3.6 or higher (plugin requires PHP 8.1+)]
- **Composer:** [e.g., 2.8.12 or higher]
